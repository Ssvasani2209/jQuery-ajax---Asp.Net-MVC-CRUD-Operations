using Asp.net_MVC_JQuery_Ajax_SV.Models;
...
//http://www.codaffection.com/asp-net-mvc-tutorial/asp-net-mvc-with-jquery-ajax/
namespace Asp.net_MVC_JQuery_Ajax_SV.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        {
            using (MVCPracticeEntities db = new MVCPracticeEntities())
            {
